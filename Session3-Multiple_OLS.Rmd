...
.center[.size45[.content-box-white[**Do states that pay a higher minimum**]]]

.center[.size45[.content-box-white[**wage see more people finish college?**]]]
...
```{r, out.width='95%'}
knitr::include_graphics('libs/Images/Session3-convert_vars4.png')
```
]
...
Remove one dummy as a baseline.
...
- Let's fit our regression and use those results to answer the question.
...
.size30[.content-box-white[**Is there a significant difference across reported**]] 

.size30[.content-box-white[**ethnicities in yearly earnings?**]]
...
d |>
  ...
  geom_point(size = 3) +
  theme_bw() +
  labs(x = "Education (Years)", y = "Yearly Earnings (2021 USDk)") +
...
.center[.size45[.content-box-white[**For Next Class**]]]

<br>

.center[.size45[What is the "best" model of bachelor's degree completion in the  Session 1 data?]]

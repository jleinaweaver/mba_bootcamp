...
v2 takes the ending exercise from session 2 and opens today with it. You gave it to them as an assignment for today.
...
### How did you do on our assignment for today?
...
.size40[
- Make predictions of real-world impact
...
We need another way to compare these two models.

- Making predictions with the models can help us translate the coefficients into real world impacts.

So, make these four predictions and think about if this changes your answer to the "best model" question.
...
4. Making predictions of real-world impact
]
...
### Are we clear on what OLS adds to our other tools?

<br>

Today we explore how OLS can allow us to build more complex models of the world.
...
### - What could we build to answer this question?
...
Sort the data by gender and use AVERAGE() on each gender separately
]]]
